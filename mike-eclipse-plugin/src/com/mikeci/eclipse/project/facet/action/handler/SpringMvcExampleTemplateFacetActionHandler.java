...
/**
 * FacetActionHandler that creates an example SpringMvc web app.
 * 
 * @author Adam Leggett
 * 
 */
public class SpringMvcExampleTemplateFacetActionHandler extends
		AbstractTemplateFacetActionHandler {
	
	private static final String SPRINGMVC_TEMPLATE_TYPE = "springmvc";


	public SpringMvcExampleTemplateFacetActionHandler(
	...
	public String getTemplateProjectType() {
		return SPRINGMVC_TEMPLATE_TYPE;
	}
